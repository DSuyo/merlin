  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="merlinApp.sales.home.createOrEditLabel">
            <Translate contentKey="merlinApp.sales.home.createOrEditLabel">Create or edit a Sales</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : salesEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="IN_CHARGE">{translate('merlinApp.State.IN_CHARGE')}</option>
                  <option value="SHIPPED">{translate('merlinApp.State.SHIPPED')}</option>
                  <option value="DELIVERED">{translate('merlinApp.State.DELIVERED')}</option>
                </AvInput>
              </AvGroup>
